...
namespace OnCourse.Domo.Groups
{
    public class GroupClient : IGroupClient
    {
        ...
        {
            var groupUri = $"v1/groups/{groupId}";
        ...
        {
            var groupUri = $"v1/groups";
            _domoHttpClient.SetAcceptRequestHeaders("application/json");
            var groupJson = JsonSerializer.Serialize(new { name = group.Name }, _serializerOptions);
        ...
        public async Task<bool> UpdateGroupAsync(int groupId, Group groupSettings)
        {
            var groupUri = $"v1/groups/{groupId}";
            _domoHttpClient.SetAcceptRequestHeaders("application/json");
            var groupSettingsJson = JsonSerializer.Serialize(groupSettings, _serializerOptions);
            var content = new StringContent(groupSettingsJson, Encoding.UTF8, "application/json");
        ...
        public async Task<IEnumerable<Group>> ListGroupsAsync(int offset, int limit)
        {
            ...
            var groupUri = $"v1/groups?offset={offset}&limit={limit}";
            _domoHttpClient.SetAcceptRequestHeaders("application/json");
        ...
        {
            var groupUri = $"v1/groups/{groupId}/users/{userId}";
            _domoHttpClient.SetAcceptRequestHeaders("application/json");
        ...
        public async Task<IEnumerable<int>> ListUsersAsync(int groupId, int offset, int limit)
        {
            ...
            var groupUri = $"v1/groups/{groupId}/users?offset={offset}&limit={limit}";
            _domoHttpClient.SetAcceptRequestHeaders("application/json");
